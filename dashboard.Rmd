...
### Number of items by top 10 department {data-height=450}
...
### Ordered hour distribution for each top 10 item {data-height=550}
...
hour_by_top_item = 
  ...
  layout(
    title = "Distribution of the ordered hour of the day for each top 10 best-selling item",
